...
grid = 3
k = 32
offline_data = h5py.File('../pythonTrain_grid' + str(grid) + '_r_real_k' + str(k) + '.mat', 'r')
...
for layers in layer_configs:
    ...
    # If want to compare different layer configs
    # filepath = "../bestLayers/" 
    ...
    # Testing/online data
    online_data = h5py.File('../pythonTest_grid' + str(grid) + '_r_real.mat', 'r')
    ...
    scipy.io.savemat(filepath_data + filename_data + '_r_real_k' + str(k) + '.mat', {'z_d': np.array(feature_d), 'phys_d': np.array(physical_d)})
